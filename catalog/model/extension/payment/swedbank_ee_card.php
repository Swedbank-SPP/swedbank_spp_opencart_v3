...
class ModelExtensionPaymentSwedbankEeCard extends Model {
    ...
    public function getMethod($address, $total) {
        ...
        if ($status) {
            $method_data = [
                'code' => 'swedbank_ee_card',
                'title' => $this->language->get('text_ee_title'),
                'terms' => '',
                'sort_order' => $this->config->get('swedbank_sort_order').'.31'
            ];
        }
